...
class _WeAreState extends State<PanelControlGestionPedidos> {
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Expanded(
              // Aquí agregamos el Expanded para que la tabla ocupe el espacio disponible
  ...
  TableRow _buildPedidoRow(String id, String cliente, String direccion,
      IconData icon, OrdenModel posts) {
    return TableRow(
      children: [
    ...
    return Column(
      ...
      children: [
        const Text('Artículos pedidos',
            style: TextStyle(fontWeight: FontWeight.bold)),
        ...List.generate(posts.platillos.length, (index) {
          return _buildCategoriaArticulos(
            [
              {
                'nombre': posts.platillos[index].nombre,
                'cantidad': posts.quantities[index],
                'precio': posts.platillos[index].precio
              }
            ],
          );
        }).toList(),
  ...
  Widget _buildCategoriaArticulos(List<Map<String, dynamic>> articulos) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        ...
        ...articulos.map((articulo) => Column(
              ...
              children: [
                ...
                //Text( '- Precio unitario: \$${articulo['precio'].toStringAsFixed(2)}'),
                //Text('- Subtotal: \$${(articulo['cantidad'] * articulo['precio']).toStringAsFixed(2)}'),
              ],
            )),
      ],
    );
  ...
  Widget _buildResumenPedido(OrdenModel posts) {
    return const Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text('Resumen del Pedido',
